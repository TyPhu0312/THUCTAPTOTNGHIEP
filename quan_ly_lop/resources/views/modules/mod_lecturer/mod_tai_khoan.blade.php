        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title">{{ $lecturer->fullname }}</h5>
                    <p class="text-muted mb-1">{{ $lecturer->lecturer_id }}</p>
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('lecturer.updateAccount') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control @error('personal_email') is-invalid @enderror"
                                    name="personal_email" value="{{ old('personal_email', $lecturer->personal_email) }}">
